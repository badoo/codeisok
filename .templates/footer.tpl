 ...
 *}
    <div class="page_footer">
        {if $project}
            ...
            <a href="/?p={$project->GetProject()|urlencode}&amp;a=rss" class="rss_logo">{t}RSS{/t}</a>
            <a href="/?p={$project->GetProject()|urlencode}&amp;a=atom" class="rss_logo">{t}Atom{/t}</a>
        {else}
            <a href="/?a=opml" class="rss_logo">{t}OPML{/t}</a>
            <a href="/?a=project_index" class="rss_logo">{t}TXT{/t}</a>
        {/if}
