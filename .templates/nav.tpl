...
<div class="git-tabs">
    <div class="git-tabs__items">
        <a class="git-tabs__item {if $current=='summary'}is-active{/if}"
           href="/?p={$project->GetProject()|urlencode}&amp;a=summary">
        ...
        <a class="git-tabs__item {if $current=='shortlog' || !$commit}{if !$commit}is-inactive{else}is-active{/if}{/if}"
           href="/?p={$project->GetProject()|urlencode}&amp;a=shortlog{if $logcommit}&amp;h={if $retbranch}{$retbranch}&amp;z={/if}{if !$branch_name }{$logcommit->GetHash()}{else}refs/heads/{$branch_name}{/if}{/if}{if $logmark}&amp;m={$logmark->GetHash()}{/if}">
            <span class="git-tabs__icon">
                <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg">
        ...
        <a class="git-tabs__item {if $current=='branchlog' || !$commit}{if !$commit}is-inactive{else}is-active{/if}{/if}"
           href="/?p={$project->GetProject()|urlencode}&amp;a=branchlog{if $logcommit}&amp;h={if $retbranch}{$retbranch}&amp;z={/if}{if !$branch_name }{$logcommit->GetHash()}{else}{$branch_name}{/if}{/if}{if $logmark}&amp;m={$logmark->GetHash()}{/if}">
            <span class="git-tabs__icon">
                <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg">
        ...
        <a class="git-tabs__item {if $current=='log' || !$commit}{if !$commit}is-inactive{else}is-active{/if}{/if}"
           href="/?p={$project->GetProject()|urlencode}&amp;a=log{if $logcommit}&amp;h={if $retbranch}{$retbranch}&amp;z={/if}{if !$branch_name }{$logcommit->GetHash()}{else}refs/heads/{$branch_name}{/if}{/if}{if $logmark}&amp;m={$logmark->GetHash()}{/if}">
            <span class="git-tabs__icon">
                <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg">
        ...
        <a class="git-tabs__item {if $current == 'commit' || !$commit || $branch}{if !$commit || $branch}is-inactive{else}is-active{/if}{/if}"
           {if $commit}
               href="/?p={$project->GetProject()|urlencode}&amp;a=commit&amp;h={$commit->GetHash()}&amp;retbranch={if $retbranch}{$retbranch}&amp;z={/if}{if $branch_name}{$branch_name}{/if}"
           {/if}
        >
            <span class="git-tabs__icon">
                <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg">
        ...
        <a class="git-tabs__item {if $current=='commitdiff' || !$commit || $branch}{if !$commit || $branch}is-inactive{else}is-active{/if}{/if}"
           {if $commit}
               href="/?p={$project->GetProject()|urlencode}&amp;a=commitdiff&amp;h={$commit->GetHash()}&amp;retbranch={if $retbranch}{$retbranch}&amp;z={/if}{if $branch_name}{$branch_name}{/if}"
           {/if}
        >
            <span class="git-tabs__icon">
                <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg">
        ...
        <a class="git-tabs__item {if $current=='tree' || !$commit}{if !$commit}is-inactive{else}is-active{/if}{/if}" href="/?p={$project->GetProject()|urlencode}&amp;a=tree{if $treecommit}&amp;hb={$treecommit->GetHash()}{/if}{if $tree}&amp;h={$tree->GetHash()}{/if}">
            <span class="git-tabs__icon">
                <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg">
        ...
        {if ($current=='shortlog' || $current == 'branchlog') && $branch_name}
            <a class="git-tabs__item"
               href="/?p={$project->GetProject()|urlencode}&amp;a=branchdiff&amp;branch={$branch_name}">
                <span class="git-tabs__icon">
                    <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg">
        ...
        <a class="git-tabs__item {if $current == 'review'}is-active{/if}"
           href="/?p={$project->GetProject()|urlencode}&amp;a=reviews">
            <span class="git-tabs__icon">
                <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg">
